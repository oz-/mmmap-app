    ...
    .is-fullwidth
      ...
      .flex-grow.is-fullheight.is-flex
        ...
        vuoz-split-view(
          ...
          .is-fullheight.is-flex(slot="first")
            vuoz-tabs(:tabs="tabs", :showAdd="false", :select="selectedTab", @select="onSelectMainTab", @close="onCloseMainTab", @dragged="onDragMainTab")
